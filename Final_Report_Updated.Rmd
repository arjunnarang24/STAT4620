...
best_models <- data.frame(
  ...
  check.names = FALSE,  # <— this stops R from fixing the names
  "10 fold CV MSE" = c(
    round(poly_cv_val, 3),
    round(gam_cv_val, 3),
